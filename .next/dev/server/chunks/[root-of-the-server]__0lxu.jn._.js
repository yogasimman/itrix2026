...
"[project]/app/api/participants/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ensureInitialized();
        const participants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllParticipants"])();
...
async function POST(request) {
    try {
        ...
        if (!participantId) {
            ...
            }while ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getParticipant"])(participantId))
        }
        // Check if ID already exists
        const existing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getParticipant"])(participantId);
        if (existing) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (autoAssignScenario && assignedRound !== 'round1') {
            const scenarios = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllScenarios"])();
            const participants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllParticipants"])();
            // Find scenarios that haven't been assigned yet
            const assignedScenarioIds = new Set(participants.filter((p)=>p.scenario_id && p.id !== participantId).map((p)=>p.scenario_id));
            ...
            if (availableScenarios.length > 0) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assignScenario"])(participantId, randomScenario.id);
                assignedScenario = randomScenario;
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logActivity"])(participantId, 'scenario_assigned', `Auto-assigned scenario: ${randomScenario.title}`);
            }
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logActivity"])(participantId, 'participant_created', `New participant created: ${name} (${assignedRound || 'unassigned'})`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            participant: {
                ...participant,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0lxu.jn._.js.map